...
describe('routeGuards', () => {
  ...
  it('allows architect access to normative rules', () => {
    expect(
      resolveAuthRedirect({
        pathname: '/normative-rules',
        hasSession: true,
        role: 'architect',
      }),
    ).toBeNull()
  ...
  it('allows administrator to normative rules', () => {
    expect(
      resolveAuthRedirect({
        pathname: '/normative-rules',
        hasSession: true,
  ...
  it('redirects legacy normative rules admin path', () => {
    expect(
      resolveAuthRedirect({
